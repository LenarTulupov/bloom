export const navItemsLeft = [
  { id: 1, href: "/catalog", name: "catalog", subItems: [
    ...
    {id: 4, href: "/catalog/dresses", name: "dresses"},
    {id: 5, href: "/catalog/tops", name: "tops"},
    {id: 6, href: "/catalog/outerwear", name: "outerwear"},
    {id: 7, href: "/catalog/blouses-shirts", name: "blouses & shirts"},
